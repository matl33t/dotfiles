...
## grep #########################################################################
function ufind() {
    find "$1" -type f -not -name "*.js" -not -name "*.css" -not -name "*.scss" -not -name "*.jpg" -not -name "*.gif" -not -path "*/cache/*" -not -name "*.png" -not -name "*.swf" -not -name "*.fla" -not -name "*.pdf" -not -name "*.swp" -not -path "*.hg/*" -not -path "*.git/*" -not -path "*.dropbox.cache/*" "$2"
}
function grep_mod() {
  if [ -z "$3" ]
